...
// AGPL-3.0 m.13 (ağ üzerinden erişim şartı): bu değiştirilmiş sürümü ağ
// üzerinden kullanan herkese, değiştirilmiş kaynak koda erişim sunulmalı.
// TODO: NEXT_PUBLIC_SOURCE_REPO_URL ortam değişkenini gerçek public GitHub
// repo adresinize ayarlayın.
const SOURCE_REPO_URL =
    process.env.NEXT_PUBLIC_SOURCE_REPO_URL ??
    "https://github.com/KULLANICI-ADINIZI-BURAYA-YAZIN/rapidact";

const NAV_ITEMS = [
    { href: "/assistant", label: "Asistan", icon: MessageSquare },
    { href: "/projects", label: "Projeler", icon: FolderOpen },
    { href: "/tabular-reviews", label: "Tablo İncelemesi", icon: Table2 },
    { href: "/workflows", label: "İş Akışları", icon: Library },
];
