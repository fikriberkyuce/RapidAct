...
export function DocumentSidePanel({
    ...
    async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            setUploadError("Yeni sürüm yüklenemedi.");
        } finally {
            setUploading(false);
        }
    }
    ...
    async function handleDeleteVersion(versionIdToDelete: string) {
        if (!canDelete) {
            onOwnerOnlyAction?.("bu belge sürümünü silme");
            return;
        }
    ...
    async function handleConfirmReplaceVersion() {
        ...
        try {
            ...
            setUploadError("Bu sürüm değiştirilemedi.");
        } finally {
    ...
    function requestDeleteDocument() {
        if (!canDelete) {
            onOwnerOnlyAction?.("bu belgeyi silme");
            return;
        }
    ...
    return createPortal(
        ...
        >
            <div
                ...
                title="Belge görünümünü yeniden boyutlandır"
            />
            ...
            >
                ...
                <div
                    ...
                    title="Belge panelini yeniden boyutlandır"
                />
                    ...
                    <div className={cn("shrink-0 p-4")}>
                        ...
                        <div className="rounded-xl bg-gray-100/70 px-3 py-3">
                            <div className="space-y-1.5">
                                ...
                                />
                                <DataRow label="Sahip" value={ownerLabel} />
                                <DataRow
                                    label="Yüklendi"
                                    value={
                                        selectedUploadedAt
                                                            ...
                                                            {deleted ? (
                                                                ...
                                                                <>
                                                                    <button
                                                                        ...
                                                                        title="Sürüm dosyasını değiştir"
                                                                    >
                                                                        {versionReplacing ? (
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        title={
                                                                            canDelete
                                                                                ? "Sürümü sil"
                                                                                : "Sürümleri yalnızca belge sahibi silebilir"
                                                                        }
                                                                    >
                                                                        {versionDeleting ? (
                                                                            <Loader2 className="h-3 w-3 animate-spin" />
                    ...
                    >
                        ...
                        <button
                            ...
                            title={
                                canDelete
                                    ? "Belgeyi sil"
                                    : "Bu belgeyi yalnızca belge sahibi silebilir"
                            }
                        >
                            {deletingDocument ? (
...
function versionTitleFor(version: DocumentVersion | null) {
    if (!version) return "bu sürüm";
    if (
        typeof version.version_number === "number" &&
        version.version_number >= 1
    ) {
        return `Sürüm ${version.version_number}`;
    }
    return "Sürüm";
}
...
function versionFilenameFor(version: DocumentVersion) {
    ...
    return version.source === "upload" ? "Orijinal" : "—";
}
