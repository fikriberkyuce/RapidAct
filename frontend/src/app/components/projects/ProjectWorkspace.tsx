...
export function ProjectWorkspaceProvider({
    ...
    async function handleProjectDetailsSave(values: {
        ...
        if (project && project.is_owner === false) {
            setOwnerOnlyAction("proje ayrıntılarını düzenleme");
            return;
        }
    ...
    function requestProjectDelete() {
        if (project && project.is_owner === false) {
            setOwnerOnlyAction("bu projeyi silme");
            return;
        }
        ...
        <ProjectWorkspaceContext.Provider value={value}>
            <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden">
                ...
                <ConfirmPopup
                    ...
                    message="Bu işlem projeyi ve ilişkili belgeleri, sohbetleri ve tablo incelemelerini kalıcı olarak silecek."
                    confirmLabel="Sil"
                    confirmStatus={
    ...
    return (
        <TableToolbar
            items={[
                ...
                { id: "assistant", label: "Asistan Sohbetleri" },
                { id: "reviews", label: "Tablo İncelemeleri" },
            ]}
