...
export function NewProjectModal({ open, onClose, onCreated }: Props) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setError((err as Error).message || "Proje oluşturulamadı");
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        <Modal
            open={open}
            onClose={handleClose}
            breadcrumbs={["Projeler", "Yeni proje"]}
            secondaryAction={{
            ...
            primaryAction={{
                label: loading ? "Oluşturuluyor…" : "Proje oluştur",
                type: "submit",
                form: formId,
        ...
        >
            ...
            >
                ...
                <input
                    ...
                    placeholder="Dosya numarası ekle..."
                        ...
                        <EmailPillInput
                            ...
                            validate={async (email) =>
                                ownEmail && email === ownEmail
                                    ? "Bir projeyi kendinizle paylaşamazsınız."
                                    : null
                            }
                            placeholder="Meslektaşları e-posta ile ekle…"
                        />
                    </div>
                )}

                <div className="mt-4 space-y-2">
                    <p className="text-xs font-medium text-gray-700">Belge seç</p>
                    <FileDirectory
