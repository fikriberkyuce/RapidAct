...
function getProjectOwnerLabel(project: Project, currentUserId?: string | null) {
    if (project.is_owner ?? project.user_id === currentUserId) return "Ben";
    return (
...
export function ProjectsOverview() {
    ...
    useEffect(() => {
        ...
        listProjects()
            ...
            .catch((err) => {
                ...
                if (!cancelled) {
                    setProjects([]);
                    setLoadError("Projeler yüklenemedi.");
                }
            })
            .finally(() => {
    ...
    async function handleDeleteSelected() {
        ...
        if (blocked > 0) {
            setOwnerOnlyAction(
                `seçili projelerden ${blocked} tanesini silme`,
            );
        }
    }
        ...
        <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden">
            ...
            <TableScrollArea>
                ...
                <TableHeaderRow>
                    ...
                    <TableHeaderCell className="ml-auto w-32">Dosya No</TableHeaderCell>
                    <TableHeaderCell className="w-32">Sahip</TableHeaderCell>
                    <TableHeaderCell className="w-24">Dosyalar</TableHeaderCell>
                    <TableHeaderCell className="w-24">Sohbetler</TableHeaderCell>
                    <TableHeaderCell className="w-36">
                        Tablo İncelemeleri
                    </TableHeaderCell>
                    <TableHeaderCell className="w-32">Oluşturulma</TableHeaderCell>
