...
function creatorLabel(chat: Chat, currentUserId?: string | null) {
    if (currentUserId && chat.user_id === currentUserId) return "Ben";
    return chat.creator_display_name?.trim() || "Paylaşılan";
}
    ...
    return (
        <TableScrollArea>
            <TableHeaderRow className="pr-8 md:pr-8">
                ...
                <TableHeaderCell className="ml-auto w-32">Oluşturan</TableHeaderCell>
                                ...
                                <RowActionMenuItems
                                    ...
                                    onRename={() => {
                                        if (
                                            ...
                                            onOwnerOnlyAction("bu sohbeti yeniden adlandırma");
                                            return;
                                        }
                                        setRenameChatValue(
