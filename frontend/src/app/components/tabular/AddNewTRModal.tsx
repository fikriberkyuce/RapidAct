    ...
    const breadcrumbs =
        isProjectMode && projectName
            ? [
                  ...
                  "Yeni Tablo İncelemesi",
              ]
            : ["Tablo İncelemeleri", "Yeni Tablo İncelemesi"];
                ...
                <div className="space-y-5">
                    ...
                    {!title.trim() && (
                        <p className="text-xs text-gray-400">
                            Oluştur&apos;a tıklayabilmek için bir inceleme adı girin.
                        </p>
                    )}
                                ...
                                <div className="relative">
                                    ...
                                    {!selectedProjectId && (
                                        <p className="mt-1.5 text-xs text-gray-400">
                                            Oluştur&apos;a tıklayabilmek için bir proje seçin.
                                        </p>
                                    )}
                                </div>
                            )}
                            ...
                            <div className="space-y-2">
                                ...
                                <div>
                                    <FileDirectory
                                        ...
                                        heading={isProjectMode ? "Proje Belgeleri" : "Belgeler"}
                                        emptyMessage={
                                            isProjectMode || underProject
                                                ? "Bu projede hazır belge yok"
                                                : "Henüz belge yok"
                                        }
                                    />
                                </div>
