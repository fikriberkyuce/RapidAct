    ...
    if (notFound || !workflow) {
        return (
            <div className="flex-1 flex items-center justify-center">
                <p className="text-gray-400 font-serif">İş akışı bulunamadı.</p>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <ConfirmPopup
                ...
                message="Bu iş akışı kalıcı olarak silinecek."
                confirmLabel="Sil"
                ...
                {workflow.type === "assistant" ? (
                    ...
                    <div className="flex flex-col flex-1 min-h-0">
                        ...
                        <div className={`flex items-center h-8 pr-3 md:pr-10 border-b border-gray-200 text-xs text-gray-500 font-medium shrink-0 select-none ${readOnly ? "border-t" : ""}`}>
                            ...
                            <div className="ml-auto w-36 shrink-0">Biçim</div>
                            <div className="flex-1 min-w-0">Talimat</div>
