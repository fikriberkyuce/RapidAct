...
export function WorkflowList() {
    ...
    const getTypeMeta = (type: Workflow["type"]) =>
        type === "tabular"
            ? { label: "Tablo", Icon: Table2, className: "text-violet-700" }
            : {
                  label: "Asistan",
                  Icon: MessageSquare,
    ...
    const practiceFilterButton = (
        <HeaderFilterDropdown
            label="Uzmanlık alanına göre filtrele"
            value={practiceFilter}
            allLabel="Tüm Uzmanlık Alanları"
        ...
        <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden">
            ...
            <TableScrollArea>
                ...
                <TableHeaderRow>
                        ...
                        <TableHeaderCell className="w-28">Kaynak</TableHeaderCell>
