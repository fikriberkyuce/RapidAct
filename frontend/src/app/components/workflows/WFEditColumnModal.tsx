                    ...
                    <div className="px-6 pt-3 pb-5 overflow-y-auto flex-1">
                        ...
                        {draft.format === "tag" && (
                            <div className="mt-3">
                                ...
                                <p className="mt-1 text-xs text-gray-400">Etiket eklemek için Enter veya virgüle basın.</p>
                            </div>
                        )}

                        {/* Prompt */}
                        <div className="mt-4 flex items-center justify-between">
                            <label className="text-sm font-medium text-gray-500">Talimat</label>
                            <button
                                type="button"
                        ...
                        <textarea
                            ...
                            placeholder="Analiz talimatını yazın — RapidAct'in bu sütun için her belgeden neyi çıkarması gerektiğini açıklayın…"
