    ...
    const breadcrumbs =
        screen === "select"
            ...
            : [
                  ...
                  wf.title,
                  wf.type === "assistant" ? "Yeni Sohbet" : "Yeni İnceleme",
              ];
    ...
    return (
        <Modal
            ...
            secondaryAction={
                screen === "select"
                    ? {
                          label: wf.is_system ? "Sayfayı Görüntüle" : "Düzenle",
            ...
            primaryAction={
                screen === "select"
                    ...
                    : wf.type === "assistant"
                      ? {
                            label: saving ? "Başlatılıyor…" : "Sohbet Başlat",
                            onClick: handleStartChat,
                            disabled:
                                saving || (inProject && !selectedProjectId),
                        }
                      : {
                            label: saving ? "Oluşturuluyor…" : "İnceleme Oluştur",
                    ...
                    <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                            ...
                            <div className="pb-3 shrink-0">
                                ...
                                <textarea
                                    ...
                                    placeholder="İş akışı talimatına ek talimatlar ekleyin…"
