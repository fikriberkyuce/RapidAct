        ...
        <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden">
            ...
            <TableScrollArea>
                <TableHeaderRow>
                    ...
                    <TableHeaderCell className="w-24">Belgeler</TableHeaderCell>
...
Yapay zekâ ile belgelerden verileri
                                    tablolara çıkarın.
                                </p>
                                <button
                                    onClick={() => setNewTROpen(true)}
                                        ...
                                        <RowActionMenuItems
                                            ...
                                            onRename={() => {
                                                if (
                                                    ...
                                                    setOwnerOnlyAction(
                                                        "bu tablo incelemesini yeniden adlandırma",
                                                    );
                                                    return;
                                                }
                                                setRenameValue(
