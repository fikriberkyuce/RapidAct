            ...
            <AccountSection>
                <div className="px-4 py-5">
                    <label className="text-sm font-medium text-gray-700 block mb-2">
                        Başlık oluşturma modeli
                    </label>
                    <p className="text-xs text-gray-400 mb-2">
                        Sohbetleri adlandırmak ve diğer hafif başlıklar için kullanılır.
                    </p>
                ...
                <div className="px-4 py-5">
                    <label className="text-sm font-medium text-gray-700 block mb-2">
                        Tablo incelemesi modeli
                    </label>
                    <p className="text-xs text-gray-400 mb-2">
Token maliyetlerini azaltmak için tablo incelemelerinde
                        daha küçük bir model kullanmanızı öneririz.
                    </p>
                    <ModelPreferenceDropdown
                        value={
                            ...
                            {items.map((m) => {
                                ...
                                return (
                                    <DropdownMenuItem
                                        ...
                                        title={
                                            !available
                                                ? `Bu modeli kullanmak için bir ${providerLabel(provider)} API anahtarı ekleyin`
                                                : undefined
                                        }
                                    >
                                        <span
