...
const TABS: TabDef[] = [
    ...
    { id: "features", label: "Özellikler", href: "/account/features" },
    {
        id: "privacy-data",
        label: "Gizlilik ve Veriler",
        href: "/account/privacy-data",
    },
    { id: "security", label: "Güvenlik", href: "/account/security" },
    { id: "models", label: "Model Tercihleri", href: "/account/models" },
    { id: "api-keys", label: "API Anahtarları", href: "/account/api-keys" },
    { id: "connectors", label: "Bağlantılar", href: "/account/connectors" },
];
