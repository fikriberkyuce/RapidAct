...
export default function FeaturesPage() {
    ...
    const handleUpdateLegalResearch = async () => {
        ...
        if (ok) {
            ...
            setSaveError("Güncellenemedi. Tekrar deneyin.");
        }
    };
                    ...
                    <div className="px-4 py-5">
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-gray-500">
                                Asistanın hangi yargı bölgelerinde araştırma
                                yapabileceğini seçin. Bir yargı bölgesi
                                etkinleştirildiğinde, ilgili içtihat araştırma
                                araçları sohbette kullanılabilir olur.
                            </p>
                        </div>
                        <div className="mt-4 flex items-start justify-between gap-3 px-3 bg-gray-50 py-3 rounded-md">
                            ...
                            >
                                <p className="text-sm text-gray-900">ABD</p>
                                <p className="text-sm text-gray-500">
                                    Sohbette ABD içtihat araştırmasını
                                    (CourtListener) etkinleştir.
                                </p>
                            </label>
                            <button
                                id="jurisdiction-us"
