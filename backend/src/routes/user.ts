...
<html>
  ...
  <body>
    <main>
      <h1>${payload.success ? "Yetkilendirme tamamlandı" : "Yetkilendirme başarısız"}</h1>
      <p>${payload.success ? "RapidAct'e dönebilirsiniz." : "RapidAct'e dönüp yeniden bağlanmayı deneyin."}</p>
    </main>
    <script nonce="${nonce}">
...
// and defaults the feature flag to disabled (US case-law research is opt-in).
